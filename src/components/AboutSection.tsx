    ...
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-screen-lg mx-auto">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t("private_secure_desc")}</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t("powerful_accessible_desc")}</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t("integrated_automated_desc")}</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-bold mb-8 text-center">{t("tech_stack")}</h3>
